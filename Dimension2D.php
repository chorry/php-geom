...
abstract class Dimension2D
{
     ...
     * precision.
     * @return int the width of this <code>Dimension</code>.
     * @since 1.2
     */
     ...
     * precision.
     * @return int the height of this <code>Dimension</code>.
     * @since 1.2
     */
     ...
     */
    public abstract function setSize();
     ...
     * @param Dimension2D $d the new size for the <code>Dimension2D</code>
     * object
     * @since 1.2
     */
    public function setSizeByDimension(Dimension2D $d)
    {
